...
mod tests {
    ...
    /// create() takes only the given subgraphs, validates cache and deployer
    ...
    /// the keys it does not already hold — the other store's meta entries
    /// among them — and unions the subgraphs.
    #[test]
